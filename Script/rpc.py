...
def generate_get_reserves_json_rpc(pairs, blockNumber='latest'):
    for pair in pairs:
        if pair['router:'] == '0xF491e7B69E4244ad4002BC14e878a34207E38c29':
            pairABI = SPOOKY_PAIR_ABI
        elif pair['router:'] == '0x16327E3FbDaCA3bcF7E38F5Af2599D2DDc33aE52':
            pairABI = SPIRIT_PAIR_ABI
